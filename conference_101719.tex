...
\subsection{Leveraging the Power of Transformer Models}

\subsection{Noise Reduction in Requirements}

\subsection{GPT-4 Text Embedding}

Our experimentation utilizes a two-step Search-Ask method to enable GPT to answer questions using a library of reference texts. We selected an SRS as an ideal SRS completely complying with IEEE Std 830 (1998) , also used in the paper \textbf{PURE: a Dataset of Public Requirements Documents}\cite{norabid2022multimodal} for benchmarking ideal functional and non-functional requirements. 
